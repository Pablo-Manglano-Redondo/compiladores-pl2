...
public class elementosParser extends Parser {
	...
	public static class NumerosContext extends ParserRuleContext {
		...
		public TerminalNode FLOTANTES() { return getToken(elementosParser.FLOTANTES, 0); }
		...
		@Override
		public void enterRule(ParseTreeListener listener) {
			if ( listener instanceof elementosListener ) ((elementosListener)listener).enterNumeros(this);
		}
		@Override
		public void exitRule(ParseTreeListener listener) {
			if ( listener instanceof elementosListener ) ((elementosListener)listener).exitNumeros(this);
		}
	}
